...
note1 = Note.create(content: "Remind her about something", task_id: task2.id)
note2 = Note.create(content: "Look at calendar", task_id: task2.id)
note3 = Note.create(content: "Email procurement", task_id: task3.id)
note4 = Note.create(content: "Finalize titles", task_id: task3.id)
note5 = Note.create(content: "How many?", task_id: task3.id)
note6 = Note.create(content: "Check for 9999", task_id: task1.id)
